...
class Tests(unittest.TestCase):
    ...
    def test_40_to_l(self):
        self.assertEqual(ar2rom(40), 'xl')

    def test_49_to_l(self):
        self.assertEqual(ar2rom(49), 'il')

    def test_51_to_l(self):
        self.assertEqual(ar2rom(51), 'li')        
